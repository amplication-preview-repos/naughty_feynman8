...
@InputType()
class CertificationCreateNestedManyWithoutCoachesInput {
...
export { CertificationCreateNestedManyWithoutCoachesInput as CertificationCreateNestedManyWithoutCoachesInput };
