...
@InputType()
class SubscriptionCreateNestedManyWithoutVideosInput {
...
export { SubscriptionCreateNestedManyWithoutVideosInput as SubscriptionCreateNestedManyWithoutVideosInput };
